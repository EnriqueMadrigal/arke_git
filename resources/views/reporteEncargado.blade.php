...
@endif
 ...
 {!! Form::open(array('action' => 'ReportesController@reporteResponsable', 'method' => 'post', 'name' => 'BuscarEncargado')) !!}
 {!! Form::label('label22', 'Responsable:', ['class' => 'col-md-4 control-label']); !!}
 {!! Form::select('id_responsable', $responsables, $id_responsable, ['class' => 'form-control']); !!}
...
<div class="text-right form-inline">
                    {!! Form::open(array('action' => 'ReportesController@reporteResponsable', 'method' => 'post', 'name' => 'generarPDF')) !!}
                    {!! Form::submit(trans('Ver PDF'), ['class' => 'btn btn-default' ]) !!}
                    {!! Form::hidden('id_responsable', $id_responsable) !!}
                    ...
                    <thead>
                        <tr>
                       <th>
                       {!! Form::open(array('action' => 'ReportesController@reporteResponsable', 'method' => 'post', 'class' =>'form-inline', 'name' => 'orderClave')) !!}
                       ...
                       {!! Form::close() !!}
                        ...
                        <th>
                       {!! Form::open(array('action' => 'ReportesController@reporteResponsable', 'method' => 'post', 'class' =>'form-inline', 'name' =>'orderDesc')) !!}
